image:https://circleci.com/gh/CircleCI-Public/dynamic-configuration-examples.svg?style=svg["CircleCI-Public", link="https://circleci.com/gh/CircleCI-Public/dynamic-configuration-examples]
